...
function YoshTexnika() {
  const id = "Yosh texnika yulduzlari";
  const { data } = useQuery({
    queryKey: ["todos", id],
    ...
    <Layout>
      <IlmiyFaoliyatWrapper>
        <BigFotoBack
          ...
          text={t("header.header__bottom__nav__item__menu.menu-5.item-2")}
        />
        <CustomTitle
          name={t("header.header__bottom__nav__item__menu.menu-5.item-2")}
        />
